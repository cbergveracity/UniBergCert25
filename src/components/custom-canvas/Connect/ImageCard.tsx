...
export const ImageCardComponent: FC<ImageCardProps> = ({title, image, component, context, slots }) => {

  const [resolvedImage] = resolveAsset(image);

  return (
    <div className="flex flex-col overflow-hidden shadow-md border border-gray-200 h-[30rem]">
      ...
      <div className="flex flex-col justify-between p-6 h-40">
